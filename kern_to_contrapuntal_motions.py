...
if __name__ == "__main__":
    midi_nums = kern_to_midi_num("C:\\Users\\sxh616_\\Desktop\\test_kern_to_midi_num.txt")
    events = midi_num_to_events(midi_nums)

    write_events("C:\\Users\\sxh616_\\Documents\\Processing\\travelling_counterpoint\\data\\contrapuntal_motions.txt", events)
